...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL enablePartnerProfiles;)
+ (BOOL)enablePartnerProfiles SWIFT_WARN_UNUSED_RESULT;
+ (void)setEnablePartnerProfiles:(BOOL)value;
